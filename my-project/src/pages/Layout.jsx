...
export default function Layout() {
  ...
  return (
    <div>
      <header>
        <nav className='flex lg:flex-row lg:justify-between items-center gap-5 p-5 lg:p-15'>
      ...
      <footer className="bg-black text-white p-30 mt-30">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          ...
          <div className="border-t border-gray-700 pt-8 text-center">
            <p className="text-sm text-gray-400">© Copyright Rimeu 2026. All right reserved</p>
          </div>
        </div>
      </footer>
    </div>
